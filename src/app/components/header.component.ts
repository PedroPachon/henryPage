...
@Component({
  ...
  template: `
    <nav [class.scrolled]="isScrolled()" [class.dark]="isDarkSection()">
      ...
      <ul class="nav-links">
        <li>
          <a href="#portfolio">{{ translationService.translations().nav.portfolio }}</a>
        </li>
        <li>
          <a href="#about">{{ translationService.translations().nav.studio }}</a>
        </li>
        <li>
          <a href="#style">{{ translationService.translations().nav.style }}</a>
        </li>
        <li><a href="#body-editor">Editor</a></li>
        <li>
          <a href="#booking">{{ translationService.translations().nav.booking }}</a>
        </li>
      </ul>
      <button class="lang-toggle" (click)="translationService.toggleLanguage()">
        {{ translationService.language() === 'en' ? 'ES' : 'EN' }}
      </button>
      <button class="nav-toggle" (click)="toggleMenu()"><span></span><span></span></button>
    </nav>
    <div class="mobile-menu" [class.open]="menuOpen()">
      <a href="#portfolio" (click)="closeMenu()">{{
        translationService.translations().nav.portfolio
      }}</a>
      ...
      <a href="#body-editor" (click)="closeMenu()">Editor</a>
      <a href="#booking" (click)="closeMenu()">{{
        translationService.translations().nav.booking
      }}</a>
    </div>
  `,
  styles: [
